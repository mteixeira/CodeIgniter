<?php
class Pneuscar_model extends CI_Model {
	public $title;
	public $description;
	public $date;
	...
	public function get_Pneus(){
		log_message('debug', __METHOD__);
		$strJsonFileContents = file_get_contents("U:/Comum/Marco Antonio/exporta/pneus.json");
		//var_dump($strJsonFileContents);
		//return ;
		//echo json_decode($strJsonFileContents, true);
